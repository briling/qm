...
void A_grad_z_old(int l, int m1, int m2, double g[3], double z[3]){
  ...
  if(acb < EPS){
    if(l == 1){
      if((m2==-1)&&(m1==-1))  g[0] =  -1.0, g[1] =   0.0, g[2] =   0.0;    //   -z[0]
      if((m2== 0)&&(m1==-1))  g[0] =   0.0, g[1] =   0.0, g[2] =   0.0;    //    0.0
      if((m2== 1)&&(m1==-1))  g[0] =   0.0, g[1] =   1.0, g[2] =   0.0;    //    z[1]
      if((m2==-1)&&(m1== 0))  g[0] =   0.0, g[1] =   1.0, g[2] =   0.0;    //    z[1]
      if((m2== 0)&&(m1== 0))  g[0] =   0.0, g[1] =   0.0, g[2] =   1.0;    //    z[2]
      if((m2== 1)&&(m1== 0))  g[0] =   1.0, g[1] =   0.0, g[2] =   0.0;    //    z[0]
      if((m2==-1)&&(m1== 1))  g[0] =   0.0, g[1] = -z[2], g[2] = -z[1];    //   -z[1]*z[2]
      if((m2== 0)&&(m1== 1))  g[0] =   0.0, g[1] =   0.0, g[2] =   0.0;    //    1.0
      if((m2== 1)&&(m1== 1))  g[0] = -z[2], g[1] =   0.0, g[2] = -z[0];    //   -z[0]*z[2]
    }
    if(l == 2){
      if((m2==-2)&&(m1==-2))  g[0] =                0.0, g[1] =        -4.0*z[1]*z[2], g[2] =        1-2*z[1]*z[1];     //     (1.0-2.0*z[1]*z[1])*z[2];
      if((m2==-1)&&(m1==-2))  g[0] =               -1.0, g[1] =                   0.0, g[2] =                  0.0;     //    -z[0];
      if((m2== 0)&&(m1==-2))  g[0] =                0.0, g[1] =                   0.0, g[2] =                  0.0;     //     0.0;
      if((m2== 1)&&(m1==-2))  g[0] =                0.0, g[1] =                   1.0, g[2] =                  0.0;     //     z[1];
      if((m2== 2)&&(m1==-2))  g[0] =     -2.0*z[1]*z[2], g[1] =        -2.0*z[0]*z[2], g[2] =       -2.0*z[0]*z[1];     //    -2.0*z[0]*z[1]*z[2];

      if((m2==-2)&&(m1==-1))  g[0] =                0.0, g[1] =                4*z[1], g[2] =                  0.0;     //     2.0*z[1]*z[1]-1.0;
      if((m2==-1)&&(m1==-1))  g[0] =              -z[2], g[1] =                   0.0, g[2] =                -z[0];     //    -z[0]*z[2];
      if((m2== 0)&&(m1==-1))  g[0] =                0.0, g[1] =                   0.0, g[2] =                  0.0;     //     0.0;
      if((m2== 1)&&(m1==-1))  g[0] =                0.0, g[1] =                  z[2], g[2] =                 z[1];     //     z[1]*z[2];
      if((m2== 2)&&(m1==-1))  g[0] =             2*z[1], g[1] =                2*z[0], g[2] =                  0.0;     //     2.0*z[0]*z[1];

      if((m2==-2)&&(m1== 0))  g[0] =       SQRT3 * z[1], g[1] =          SQRT3 * z[0], g[2] =                  0.0;     //     SQRT3 * z[1]*z[0];
      if((m2==-1)&&(m1== 0))  g[0] =                0.0, g[1] =          SQRT3 * z[2], g[2] =         SQRT3 * z[1];     //     SQRT3 * z[1]*z[2];
      if((m2== 0)&&(m1== 0))  g[0] =                0.0, g[1] =                   0.0, g[2] =             3.0*z[2];     //     1.5*z[2]*z[2]-0.5;
      if((m2== 1)&&(m1== 0))  g[0] =       SQRT3 * z[2], g[1] =                   0.0, g[2] =         SQRT3 * z[0];     //     SQRT3 * z[0]*z[2];
      if((m2== 2)&&(m1== 0))  g[0] =                0.0, g[1] =       -2.0*SQRT3*z[1], g[2] =                  0.0;     //     SQRT3 * (0.5-z[1]*z[1]);

      if((m2==-2)&&(m1== 1))  g[0] =     -2.0*z[1]*z[2], g[1] =        -2.0*z[0]*z[2], g[2] =       -2.0*z[0]*z[1];     //    -2.0*z[0]*z[1]*z[2];
      if((m2==-1)&&(m1== 1))  g[0] =                0.0, g[1] =         1-2*z[2]*z[2], g[2] =       -4.0*z[1]*z[2];     //     z[1]*(1.0-2.0*z[2]*z[2]);
      if((m2== 0)&&(m1== 1))  g[0] =                0.0, g[1] =                   0.0, g[2] =                SQRT3;     //     SQRT3 * z[2];
      if((m2== 1)&&(m1== 1))  g[0] =      1-2*z[2]*z[2], g[1] =                   0.0, g[2] =       -4.0*z[0]*z[2];     //    -z[0]*(2.0*z[2]*z[2]-1.0);
      if((m2== 2)&&(m1== 1))  g[0] =                0.0, g[1] =         4.0*z[1]*z[2], g[2] =        2*z[1]*z[1]-1;     //     z[2]*(2.0*z[1]*z[1]-1.0);

      if((m2==-2)&&(m1== 2))  g[0] = z[1]*(1+z[2]*z[2]), g[1] =    z[0]*(1+z[2]*z[2]), g[2] =     2*z[0]*z[1]*z[2];     //     z[0]*z[1]*(1.0+z[2]*z[2]);
      if((m2==-1)&&(m1== 2))  g[0] =                0.0, g[1] =                 -z[2], g[2] =                -z[1];     //    -z[1]*z[2];
      if((m2== 0)&&(m1== 2))  g[0] =                0.0, g[1] =                   0.0, g[2] =                  0.0;     //     SQRT3*0.5;
      if((m2== 1)&&(m1== 2))  g[0] =              -z[2], g[1] =                   0.0, g[2] =                -z[0];     //    -z[0]*z[2];
      if((m2== 2)&&(m1== 2))  g[0] =                0.0, g[1] = -2*z[1]*(1+z[2]*z[2]), g[2] = (1-2*z[1]*z[1])*z[2];     //     (0.5-z[1]*z[1])*(1.0+z[2]*z[2]);
    }
  }
  else if(fabs(acb-1.0)>EPS){

#define    SB(Z)   (sqrt(1.0-(Z)*(Z)))
#define   SB1(Z)   (1.0/SB(Z))
#define dSB1dZ(Z)  ((Z)/(sqrt(1.0-(Z)*(Z))*(1.0-(Z)*(Z))))
#define dSB_dZ(Z)  (-(Z)/SB(Z))

    if(l == 1){
      if((m2==-1)&&(m1==-1))  g[0] = -1.0  / SB(z[2]) , g[1] =  0.0             , g[2] = -z[0] * dSB1dZ(z[2])                     ; // -z[0] / sqrt(1.0-z[2]*z[2])    ;
      if((m2== 0)&&(m1==-1))  g[0] =  0.0             , g[1] =  0.0             , g[2] =  0.0                                     ; //  0.0   ;
      if((m2== 1)&&(m1==-1))  g[0] =  0.0             , g[1] =  1.0  / SB(z[2]) , g[2] =  z[1] * dSB1dZ(z[2])                     ; //  z[1] / sqrt(1.0-z[2]*z[2])    ;
      if((m2==-1)&&(m1== 0))  g[0] =  0.0             , g[1] =  1.0             , g[2] =  0.0                                     ; //  z[1] ;
      if((m2== 0)&&(m1== 0))  g[0] =  0.0             , g[1] =  0.0             , g[2] =  1.0                                     ; //  z[2]    ;
      if((m2== 1)&&(m1== 0))  g[0] =  1.0             , g[1] =  0.0             , g[2] =  0.0                                     ; //  z[0] ;
      if((m2==-1)&&(m1== 1))  g[0] =  0.0             , g[1] = -z[2] / SB(z[2]) , g[2] = -z[1]*(1.0/SB(z[2]) + z[2]*dSB1dZ(z[2])) ; // -z[1]*z[2] / sqrt(1.0-z[2]*z[2]) ;
      if((m2== 0)&&(m1== 1))  g[0] =  0.0             , g[1] =  0.0             , g[2] =  dSB_dZ(z[2])                            ; //  sqrt(1.0-z[2]*z[2])    ;
      if((m2== 1)&&(m1== 1))  g[0] = -z[2] / SB(z[2]) , g[1] =  0.0             , g[2] = -z[0]*(1.0/SB(z[2]) + z[2]*dSB1dZ(z[2])) ; // -z[0]*z[2] / sqrt(1.0-z[2]*z[2]) ;
    }

    if(l == 2){

      if((m2==-2)&&(m1==-2))  g[0] =  0.0                                     , g[1] = -4.0*z[1]*z[2] / (1.0-z[2]*z[2])            , g[2] =  1.0 - 2.0*z[1]*z[1] * (1.0+z[2]*z[2]) / ( (1.0-z[2]*z[2])*(1.0-z[2]*z[2]) )        ; //   (1.0 - 2.0*z[1]*z[1] / (1.0-z[2]*z[2])  ) * z[2];
      if((m2==-1)&&(m1==-2))  g[0] = -1.0                                     , g[1] =  0.0                                        , g[2] =  0.0                                                                                ; //  -z[0];
      if((m2== 0)&&(m1==-2))  g[0] =  0.0                                     , g[1] =  0.0                                        , g[2] =  0.0                                                                                ; //   0.0;
      if((m2== 1)&&(m1==-2))  g[0] =  0.0                                     , g[1] =  1.0                                        , g[2] =  0.0                                                                                ; //   z[1];
      if((m2== 2)&&(m1==-2))  g[0] = -2.0*z[1]*z[2] / (1.0-z[2]*z[2])         , g[1] = -2.0*z[0]*z[2] / (1.0-z[2]*z[2])            , g[2] = -2.0*z[0]*z[1] * (1.0+z[2]*z[2]) / ((1.0-z[2]*z[2])*(1.0-z[2]*z[2]))                ; //  -2.0*z[0]*z[1]*z[2] / (1.0-z[2]*z[2]) ;

      if((m2==-2)&&(m1==-1))  g[0] =  0.0                                     , g[1] =  4.0*z[1]/sqrt(1.0-z[2]*z[2])               , g[2] =  2.0*z[1]*z[1] * dSB1dZ(z[2]) - dSB_dZ(z[2])                                        ; //   2.0*z[1]*z[1]/sqrt(1.0-z[2]*z[2]) - sqrt(1.0-z[2]*z[2]);
      if((m2==-1)&&(m1==-1))  g[0] = -z[2]/sqrt(1.0-z[2]*z[2])                , g[1] =  0.0                                        , g[2] = -z[0]* (1.0/SB(z[2]) + z[2]*dSB1dZ(z[2]))                                           ; //  -z[0]*z[2]/sqrt(1.0-z[2]*z[2]);
      if((m2== 0)&&(m1==-1))  g[0] =  0.0                                     , g[1] =  0.0                                        , g[2] =  0.0                                                                                ; //   0.0;
      if((m2== 1)&&(m1==-1))  g[0] =  0.0                                     , g[1] =  z[2]/sqrt(1.0-z[2]*z[2])                   , g[2] =  z[1]* (1.0/SB(z[2]) + z[2]*dSB1dZ(z[2]))                                           ; //   z[1]*z[2]/sqrt(1.0-z[2]*z[2]);
      if((m2== 2)&&(m1==-1))  g[0] =  2.0*z[1]/sqrt(1.0-z[2]*z[2])            , g[1] =  2.0*z[0]/sqrt(1.0-z[2]*z[2])               , g[2] =  2.0*z[0]*z[1] * dSB1dZ(z[2])                                                       ; //   2.0*z[0]*z[1]/sqrt(1.0-z[2]*z[2]);

      if((m2==-2)&&(m1== 0))  g[0] =  SQRT3 * z[1]                            , g[1] =  SQRT3 * z[0]                               , g[2] =  0.0                                                                                ; //   SQRT3 * z[0] * z[1];
      if((m2==-1)&&(m1== 0))  g[0] =  0.0                                     , g[1] =  SQRT3 * z[2]                               , g[2] =  SQRT3 * z[1]                                                                       ; //   SQRT3 * z[1] * z[2];
      if((m2== 0)&&(m1== 0))  g[0] =  0.0                                     , g[1] =  0.0                                        , g[2] =  3.0*z[2]                                                                           ; //   1.5*z[2]*z[2]-0.5;
      if((m2== 1)&&(m1== 0))  g[0] =  SQRT3 * z[2]                            , g[1] =  0.0                                        , g[2] =  SQRT3 * z[0]                                                                       ; //   SQRT3 * z[0]*z[2];
      if((m2== 2)&&(m1== 0))  g[0] =  0.0                                     , g[1] = -2.0*SQRT3 * z[1]                           , g[2] = -SQRT3 * z[2]                                                                       ; //   SQRT3 * ((1.0-z[2]*z[2])*0.5-z[1]*z[1]);

      if((m2==-2)&&(m1== 1))  g[0] = -2.0*z[1]*z[2] / sqrt(1.0-z[2]*z[2])     , g[1] = -2.0*z[0]*z[2] / sqrt(1.0-z[2]*z[2])        , g[2] = -2.0*z[0]*z[1]*(1.0/SB(z[2]) + z[2]*dSB1dZ(z[2]))                                   ; //  -2.0*z[0]*z[1]*z[2] / sqrt(1.0-z[2]*z[2]);
      if((m2==-1)&&(m1== 1))  g[0] =  0.0                                     , g[1] =  (1.0-2.0*z[2]*z[2]) / sqrt(1.0-z[2]*z[2])  , g[2] =  z[1] * ( (1.0-2.0*z[2]*z[2])*dSB1dZ(z[2]) - 4.0*z[2]/SB(z[2]) )                    ; //   z[1]*(1.0-2.0*z[2]*z[2]) / sqrt(1.0-z[2]*z[2]);
      if((m2== 0)&&(m1== 1))  g[0] =  0.0                                     , g[1] =  0.0                                        , g[2] =  SQRT3 * ( SB(z[2]) - z[2]*z[2]/SB(z[2]) )                                          ; //   SQRT3 *z[2] * sqrt(1.0-z[2]*z[2]);
      if((m2== 1)&&(m1== 1))  g[0] =  (1.0-2.0*z[2]*z[2])/sqrt(1.0-z[2]*z[2]) , g[1] =  0.0                                        , g[2] =  z[0] * ( (1.0-2.0*z[2]*z[2])*dSB1dZ(z[2]) - 4.0*z[2]/SB(z[2]) )                    ; //   z[0]*(1.0-2.0*z[2]*z[2])/sqrt(1.0-z[2]*z[2]);
      if((m2== 2)&&(m1== 1))  g[0] =  0.0                                     , g[1] =  4.0*z[1]*z[2]/sqrt(1.0-z[2]*z[2])          , g[2] =  2.0*z[1]*z[1]/SB(z[2]) - SB(z[2]) + z[2]*(2.0*z[1]*z[1]*dSB1dZ(z[2])-dSB_dZ(z[2])) ; //   z[2] * (2.0*z[1]*z[1]/sqrt(1.0-z[2]*z[2]) - sqrt(1.0-z[2]*z[2]) );

      if((m2==-2)&&(m1== 2))  g[0] =  z[1]*(1.0+z[2]*z[2]) / (1.0-z[2]*z[2])  , g[1] =  z[0]*(1.0+z[2]*z[2]) / (1.0-z[2]*z[2])     , g[2] =  z[0]*z[1]* 4.0*z[2] / ( (1.0-z[2]*z[2])*(1.0-z[2]*z[2]) )                          ; //   z[0]*z[1]*(1.0+z[2]*z[2]) / (1.0-z[2]*z[2]);
      if((m2==-1)&&(m1== 2))  g[0] =  0.0                                     , g[1] = -z[2]                                       , g[2] = -z[1]                                                                               ; //  -z[1]*z[2];
      if((m2== 0)&&(m1== 2))  g[0] =  0.0                                     , g[1] =  0.0                                        , g[2] = -SQRT3*z[2]                                                                         ; //   SQRT3*0.5*(1.0-z[2]*z[2]);
      if((m2== 1)&&(m1== 2))  g[0] = -z[2]                                    , g[1] =  0.0                                        , g[2] = -z[0]                                                                               ; //  -z[0]*z[2];
      if((m2== 2)&&(m1== 2))  g[0] =  0.0                                     , g[1] = -2.0*z[1]*(1.0+z[2]*z[2]) / (1.0-z[2]*z[2]) , g[2] =  z[2] - z[1]*z[1]* 4.0*z[2] / ( (1.0-z[2]*z[2])*(1.0-z[2]*z[2]) )                   ; //   (0.5 - z[1]*z[1]/(1.0-z[2]*z[2]) )*(1.0+z[2]*z[2]);
    }
  }
  else{
    if(l == 1){
      if((m2== 0)&&(m1== 0))  g[2] = 1.0     ;  //  z[2]
      if((m2== 1)&&(m1== 1))  g[2] = 1.0     ;  //  z[2]
    }
    if(l == 2){
      if((m2==-2)&&(m1==-2))  g[2] = 1.0     ;  //  z[2]
      if((m2==-1)&&(m1==-1))  g[2] = 1.0     ;  //  z[2]
      if((m2== 0)&&(m1== 0))  g[2] = 3.0*z[2];  //  1.5*z[2]*z[2]-0.5
      if((m2== 1)&&(m1== 1))  g[2] = 4.0*z[2];  //  2.0*z[2]*z[2]-1.0
      if((m2== 2)&&(m1== 2))  g[2] = z[2]    ;  //  0.5*(1.0+z[2]*z[2])
    }
  }
  return;
}
